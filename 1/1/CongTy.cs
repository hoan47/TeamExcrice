...
namespace _1
{
    class CongTy
    {
        ...
        public CongTy(DateTime thoiDiem, int soNgayChoNghiCuaThang, decimal luongCoBan)
        {
        ...
        public void LuongMotThangCongTyPhaiTra()
        {
            ...
            Console.WriteLine($"Luong thang {thoiDiem.ToString("MM")} cong ty phai tra la: " + string.Format("{0:N0}", luong) + " VND");
        }
