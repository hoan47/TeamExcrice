...
namespace DoAnCuoiKy
{
    internal static class ChayChuongTrinh
    {
        public static void ChuongTrinh()
        {
            ...
            List<ChuXe> danhSachChuXe = ChuXe.DocDuLieu(danhSachNganHang);
            List<TaiXe> danhSachTaiXe = TaiXe.DocDuLieu(danhSachNganHang);
            List<KhachThueXe> danhSachKhachThueXe = KhachThueXe.DocDuLieu(danhSachNganHang);
                                ...
                                if (danhSachXeTimDuoc.Count > 0)
                                {
                                    ...
                                    void ChuongTrinhHopDong()
                                    {
                                        ...
                                        void ChuongTrinhKetThucHopDong()
                                        {
                                            ...
                                            {
                                                case 1:
                                                    bool kiemTraXuotXe = chuChoThue.KiemTraXeSauKhiTra("Xuot xe: ");
                                                    bool kiemTraHuDen = chuChoThue.KiemTraXeSauKhiTra("Hu den: ");
                                                    bool kiemTraBeBanh = chuChoThue.KiemTraXeSauKhiTra("Be banh: ");
                                                    int soNgayTre = DauVaoBanPhim.Int(1, 7, "Chon so ngay tre han tra xe (tu 1 toi 7 ngay): ");
                                                    hopDong.KetThucThueXe(kiemTraXuotXe, kiemTraBeBanh, kiemTraHuDen, soNgayTre);
